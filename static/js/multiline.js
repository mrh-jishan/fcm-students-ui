...
// Change chart size according to window size
    chartObj.update_svg_size = function () {
        ...
        chartObj.chartDiv.select('svg')
            .attr("width", chartObj.width + (chartObj.margin.left + chartObj.margin.right)).attr("height", chartObj.height + (chartObj.margin.top + chartObj.margin.bottom));
...
// Render the chart
    chartObj.render = function () {
        ...
        function mousemove() {
            ...
            focus.select(".focus.year").text("Time: t-" + chartObj.xFormatter(chartObj.xFunct(d)));
        }
